...
@class MudicKindAlbum,MusicKindTracks,MusicKindList;
@interface MusicKindModel : BaseModel

@property (nonatomic, strong) MusicKindTracks *tracks;

@property (nonatomic, strong) MudicKindAlbum *album;
...
@end
@interface MudicKindAlbum : NSObject
...
@interface MusicKindTracks : NSObject

@property (nonatomic, assign) NSInteger maxPageId;

@property (nonatomic, strong) NSArray<MusicKindList *> *list;
...
@interface MusicKindList : NSObject
