...
@class FuWenListPurpleModel;
@interface FuWenListModel : BaseModel

@property (nonatomic, strong) NSArray<FuWenListPurpleModel *> *Purple;

@property (nonatomic, strong) NSArray<FuWenListPurpleModel *> *Blue;

@property (nonatomic, strong) NSArray<FuWenListPurpleModel *> *Yellow;

@property (nonatomic, strong) NSArray<FuWenListPurpleModel *> *Red;

@end
@interface FuWenListPurpleModel : NSObject
